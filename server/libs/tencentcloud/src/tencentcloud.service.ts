...
import { LexicalAnalysisRequest } from 'tencentcloud-sdk-nodejs/tencentcloud/services/nlp/v20190408/nlp_models'
...
export class TencentcloudService {
    ...
    async lexicalAnalyze(text){
        ...
        const data = await this.client.LexicalAnalysis(req)
